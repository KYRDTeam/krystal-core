...
import {IDMMFactory, IDMMRouter, IERC20Ext, IUniswapV2Router02, IAggregationRouter} from '../typechain';
            ...
            await setup.proxyInstance.swap(
              {
                ...
                extraArgs: await generateArgsFunc(tradePath, nativeAmount, FeeMode.FROM_SOURCE),
              },
              {
