...
contract UniSwapV3Thruster is BaseSwap {
    ...
    function getAmount(
        ...
        IThrusterPoolDeployer poolDeployer = IThrusterPoolDeployer(address(router.factory()));
        IUniswapV3Factory factory = IUniswapV3Factory(address(poolDeployer.factory()));

        IUniswapV3Pool pool = IUniswapV3Pool(address(factory.getPool(tokenIn, tokenOut, fee)));
